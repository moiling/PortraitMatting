...
set img=D:/Dataset/Adobe_Half_Human/comp/image
set tmp=D:/Dataset/Adobe_Half_Human/comp/trimap
set mat=D:/Dataset/Adobe_Half_Human/comp/alpha
set fg=D:/Dataset/Adobe_Half_Human/comp/fg
set bg=D:/Dataset/Adobe_Half_Human/comp/bg
