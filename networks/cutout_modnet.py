...
class CutoutMODNet(nn.Module):
    ...
    def forward(self, img, inference=True):
        ...
        # change to: return cutout, cutout, cutout, cutout when tracing.
        return pred_matte, pred_semantic, cutout, pred_detail
