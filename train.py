...
parser.add_argument('--img',        type=str,   default='D:/Dataset/zt4k/train/image',   help='training images.')
parser.add_argument('--trimap',     type=str,   default='D:/Dataset/zt4k/train/trimap',   help='intermediate trimaps.')
parser.add_argument('--matte',      type=str,   default='D:/Dataset/zt4k/train/alpha',   help='final mattes.')
parser.add_argument('--fg',         type=str,   default='D:/Dataset/zt4k/train/fg',   help='fg for loss.')
parser.add_argument('--bg',         type=str,   default='D:/Dataset/zt4k/train/bg',   help='bg for loss.')
parser.add_argument('--val-out',    type=str,   default='data',   help='val image out.')
parser.add_argument('--val-img',    type=str,   default='D:/Dataset/zt4k/test/image',   help='val images.')
parser.add_argument('--val-trimap', type=str,   default='D:/Dataset/zt4k/test/trimap',   help='intermediate val trimaps.')
parser.add_argument('--val-matte',  type=str,   default='D:/Dataset/zt4k/test/alpha',   help='val mattes.')
parser.add_argument('--val-fg',     type=str,   default='D:/Dataset/zt4k/test/fg',   help='val fg.')
parser.add_argument('--val-bg',     type=str,   default='D:/Dataset/zt4k/test/bg',   help='val bg.')
...
for epoch in range(start_epoch, args.epoch + 1):
    ...
    for idx, batch in enumerate(train_data_loader):
        ...
        """ Forward """
        pm, ptp, pmu, pfu = model(img, trimap_3)

        """ Calculate Loss """
        loss = matting_loss(img, ptp, pm, pmu, pfu, gt_trimap_3, gt_matte, args.mode, gt_fg, gt_bg)
        """ Back Propagate """
        optimizer.zero_grad()
        loss.backward()
        """ Update Parameters """
    ...
    with torch.no_grad():
        for idx, batch in enumerate(val_data_loader):
            ...
            utils.save_images(args.val_out, batch['name'], pm, ptp, pmu, pfu, logger)
